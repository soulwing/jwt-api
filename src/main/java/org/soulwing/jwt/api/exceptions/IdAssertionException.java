...
/**
 * An exception thrown when an assertion about the {@code JTI} claim
 * is not satisfied.
 *
 * @author Carl Harris
 */
public class IdAssertionException extends JWTAssertionFailedException {
  ...
  public IdAssertionException() {
    this("Claim `" + Claims.JTI + "` is required, but not present");
  }

  public IdAssertionException(String message) {
    super(message);
  }
